...
- 극성:
  · 긍정: 
    1. 사실 전달형·수치 포함
    예: “기획재정부는 내년 물가 상승률을 3%로 전망했는데, 내년 물가가 5%까지 뛸 수도 있다.”
    → 숫자·전망 같은 사실 전달 문장은 긍정.
    2. 묘사 중심
    예: “일렁이는 파도와 바람, 섬, 소나무의 모습을 한눈에 담으면 움직이는 게 바람인지…”
    → 긍정적 정서(아름다움)가 담겼으니 긍정.
    3. 완곡·간접 표현
    예: “본업인 연기를 잘하면 해결될 일이니까(웃음).”
    → 간접적·농담 섞인 표현으로 긍정.
    4. 단순 진술
    예: “현재 유행하는 A형 독감은 12월 말~2월 초가 시즌이다.”
    → 사실 전달도 긍정.
    5. 조건적 긍정
    예: “세계 최고 교육 수준 덕분에 범죄 유형도 머리를 쓰는 쪽으로 진화했다.”
    → 교육 수준이 높다는 긍정.
